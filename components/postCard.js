        ...
        <div className={styles.postCard}>
            <h1>{`${title.charAt(0).toUpperCase()}${title.slice(1)}`}</h1>
                {news.length === 10 &&<div className={styles.postCardTiles}>
                    <Link href={type === 'post' ? `/post/${news[0].postID}`: `/movie/${news[0]._id}`} className={`${styles.tile} ${styles.one}`} replace>
                    ...
                    <Link href={type === 'post' ? `/post/${news[1].postID}`: `/movie/${news[1]._id}`} className={`${styles.tile} ${styles.two}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[2].postID}`: `/movie/${news[2]._id}`}  className={`${styles.tile} ${styles.three}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[3].postID}`: `/movie/${news[3]._id}`} className={`${styles.tile} ${styles.four}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[4].postID}`: `/movie/${news[4]._id}`} className={`${styles.tile} ${styles.five}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[5].postID}`: `/movie/${news[5]._id}`}  className={`${styles.tile} ${styles.six}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[6].postID}`: `/movie/${news[6]._id}`} className={`${styles.tile} ${styles.seven}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[7].postID}`: `/movie/${news[7]._id}`} className={`${styles.tile} ${styles.eight}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[8].postID}`: `/movie/${news[8]._id}`} className={`${styles.tile} ${styles.nine}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={type === 'post' ? `/post/${news[9].postID}`: `/movie/${news[9]._id}`} className={`${styles.tile} ${styles.ten}`} replace>
                        <div className={styles.tileImage}>
