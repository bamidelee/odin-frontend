        ...
        <div className={styles.postCard}>
            <h1>{`${title.charAt(0).toUpperCase()}${title.slice(1)}`}</h1>
                {news.length === 10 &&<div className={styles.postCardTiles}>
                    <Link href={`/post/${news[0].postID}`} className={`${styles.tile} ${styles.one}`} replace>
                    ...
                    <Link href={`/post/${news[1].postID}`} className={`${styles.tile} ${styles.two}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[2].postID}`}  className={`${styles.tile} ${styles.three}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[3].postID}`} className={`${styles.tile} ${styles.four}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[4].postID}`} className={`${styles.tile} ${styles.five}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[5].postID}`}  className={`${styles.tile} ${styles.six}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[6].postID}`} className={`${styles.tile} ${styles.seven}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[7].postID}`} className={`${styles.tile} ${styles.eight}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[8].postID}`} className={`${styles.tile} ${styles.nine}`} replace>
                        <div className={styles.tileImage}>
                    ...
                    <Link href={`/post/${news[9].postID}`} className={`${styles.tile} ${styles.ten}`} replace>
                        <div className={styles.tileImage}>
